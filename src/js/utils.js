export let colors, colorsRegExp, isAllSame, getPosClass, replacePosClass, getCor, isNear, getColor, isNotMatched, getRandomInt,
    destroy;

getRandomInt = (max) => Math.floor(Math.random() * Math.floor(max));

colors = ["apple", "meat", "pizza", "rice", "sweet"];
colorsRegExp = new RegExp(colors.join("|")); // new RegExp(/gold|silver|violet/);
